 /**
  * PUBLIC_INTERFACE
  * Report Generator (Premium) – Markdown editor, live preview, screenshot/export placeholder. Modern, dark, premium layout.
  */
...
function markdownToHtml(md) {
  // Minimal offline markdown translation (demo only)
  let html = md
    .replace(/^# (.+)/gm, "<h2>$1</h2>")
    .replace(/^## (.+)/gm, "<h3>$1</h3>")
    ...
    <div>
      <div className="panel" style={{ marginBottom: 32 }}>
        <div className="panel-header" style={{display:"flex",alignItems:"center",gap:9}}>
          Report Generator <span className="badge">Beta</span><span className="badge-faint">Premium</span>
        </div>
