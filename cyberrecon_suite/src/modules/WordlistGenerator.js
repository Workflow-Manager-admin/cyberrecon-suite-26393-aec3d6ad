 /**
  * PUBLIC_INTERFACE
  * Wordlist Generator (Premium) – Paste/upload file, TF-IDF demo, keyword export. Utility classes, modern polish.
  */
    ...
    <div>
      <div className="panel" style={{ marginBottom: "32px" }}>
        <div className="panel-header" style={{display:"flex",alignItems:"center",gap:9}}>
          Wordlist Generator <span className="badge">Beta</span><span className="badge-faint">Premium</span>
        </div>
      ...
      <div className="description" style={{ marginTop: "16px", color: "#babfc7" }}>
        ...
        <span className="badge-faint">Feature Roadmap Soon</span>
